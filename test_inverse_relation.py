...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', default='data/portability/Inverse_Relation/zsre_inverse_relation.json', type=str)
    parser.add_argument('--data', default='counterfact', type=str)
    parser.add_argument('--ds_size', default=None, type=int)
    parser.add_argument('--metrics_save_dir', default='output/portability/inverse_relation', type=str)
    ...
    for edit_data_ in test_data:        
        ...
        inverse_question.append(edit_data_['inverse question'])
    assert len(prompts) == len(inverse_question) == len(target_new) == len(subject)
    
    portability_inputs = {
        'inverse_question':{
            'prompt': inverse_question,
